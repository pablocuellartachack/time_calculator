...
start_time = input("Enter the start time (e.g., 11:06 PM): ")
duration_time = input("Enter the duration time (e.g., 2:02): ")
user_day_of_week = input("Enter the day of the week (optional): ")

result = add_time(start_time, duration_time, user_day_of_week)
print(result)